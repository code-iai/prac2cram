...
core = {'action_core_name': 'dbg-prac2cram', 'action_roles': [{'role_name': 'content', 'role_value': 'phenolphtaleine'}, {'role_name': 'goal', 'role_value': 'purine'}, {'role_name': 'amount', 'role_value': '2'}, {'role_name': 'unit', 'role_value': 'drops'}]}
action_cores = [core]
tasks = [action_cores]
